# -*- coding: utf-8 -*-
"""Vision Transformer without Finetuning Performance on Flamingo Data

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_J-Yf2XXq7W1f87sLIccwkb5SIf4YNMo
"""

"""
SLURM batch job: heavy-compute of the ViT analysis -- FLAMINGO DATA
(same pipeline the QE flamingo script used), STAGE-24 CHECKPOINT,
comparison-format outputs.
...
STAGE_TO_LOAD = 24   # matches vit_compute_job_base_generated.py
...
OUT_DIR = os.path.join(DATA_DIR, "final_vit_base_flamingo")
...
RESULTS_FILE = os.path.join(OUT_DIR, f"vit_results_base_flamingo_stage{STAGE_TO_LOAD}_{SNAPSHOT_TAG}.npz")

# --- TEST DATA: same flamingo_real_* files, loaded the same simple way,
# as qe_binned_standalone_l10_5000_flamingo.py -- READ ONLY, no regeneration.
TEST_FILES = {
...
##  qe_binned_standalone_l10_5000_flamingo.py -- plain np.load, no
...
print(f"Loaded FLAMINGO test maps from {DATA_DIR} (original, unrotated) -- same source as the QE flamingo run.")
